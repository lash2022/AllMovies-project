import {Component, computed, CUSTOM_ELEMENTS_SCHEMA, Injector} from '@angular/core';
...
@Component({
  ...
  imports: [CommonModule, SliderComponent, TrailersActorsComponent, ListCardComponent, ActorCardComponent],
